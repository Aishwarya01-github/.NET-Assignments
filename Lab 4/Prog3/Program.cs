...
namespace Code_3
{
  class Program
  {
    ...
    {
      Employee e1 = new Employee("Aishwarya", "Mundley", 45000);
      Employee e2 = new Employee("Aditya", "Mundley", 23000);
      ...
      PermanentEmployee pe1 = new PermanentEmployee("Aishwarya", "Mundley", 45000, 2000, 1000, 4500, "01-02-2022", "10-05-2022");

      PermanentEmployee pe2 = new PermanentEmployee("Aditya", "Mundley", 23000, 2789, 500, 9500, "01-01-2022", "18-12-2022");
